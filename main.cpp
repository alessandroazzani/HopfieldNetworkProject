...
public:
	...
	double get_average_sync(int steps){
		...
		return sync_average / (time_active + time_passive);
	}
...
int main() {
	...
	double par_min = 1.3;//parametro generico...
	double par_max = 2.3;
	double par_jump = .1;
	int steps = 300;
	int N = 5;
